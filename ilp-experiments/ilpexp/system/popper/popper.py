...
def generate_bk_file(data_path, base_bk_file, problem_bk_file=None):
    ...
    bk_file = mkfile(data_path, 'common_bk.pl')
...
def generate_bias_file(data_path, base_bias_file, problem_bias_file=None, additional_bias=None):
    ...
    bias_file = mkfile(data_path, 'popper-bias.pl')
...
class Popper(System):
    ...
    def train(self, train_settings):
        ...
        if stats:
            ...
            if solution:
                code = solution["code"] if solution["code"] else None
...
BASIC_POPPER = Popper("../numsynth", {}, timeout=60)
